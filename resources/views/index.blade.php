              ...
              @foreach($location_data as $d)
    					<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(<?=$d->location_picture?>);">
		    						<div class="icon d-flex justify-content-center align-items-center">	
		    						</div>
		    					</a>
		    					<div class="text p-3">
		    						<h3><a href="location/<?=$d->location_name?>"><?=$d->location_name?></a></h3>
		    					</div>
		    				</div>
	    				</div>
